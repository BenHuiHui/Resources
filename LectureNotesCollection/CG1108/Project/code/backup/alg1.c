...
int main()  
{
int BACK_COUNT_MAX = 30000;
int TURN_COUNT_MAX = 2000;
int blackTurnCounter = 0;
int turnCounter = 0;
char base;
char turnBase;
char turnFast;
...
while(1)
{
	...
	/* blackTurn = 
	    0: straight
	    1: former left black
	    2: former right black
	*/
	if(backCounter!=0){
	  if(backCounter== BACK_COUNT_MAX){
	    backCounter= 0;
	  } else{
	    backCounter++;
	  }
