...
void SPI_Write8B(unsigned char data)
{
	 unsigned char i;
...
void NRF905_Init()
{
	unsigned char NRF905_CONFIG[10] = {0x4c, 0x0c, 0x44, 0x20, 0x20, 0xcc, 0xcc, 0xcc, 0xcc, 0x58};
	...
	for( i = 0; i < 10; i++)
		SPI_Write8B(NRF905_CONFIG[i]);

	SPI_Disable();
}

//data is a 32-byte unsigned char array
void NRF905_ReceivePacket(unsigned char *data)
{
	unsigned char i;
